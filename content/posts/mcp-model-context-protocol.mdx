...
![MCP：AI 的 USB-C，Before vs After 对比](/images/mcp-model-context-protocol/usb-c-analogy.jpeg)
...
![MCP 三层架构：Host → Client → Server](/images/mcp-model-context-protocol/architecture.jpeg)
...
![Function Calling vs MCP：单平台绑定 vs 跨平台标准](/images/mcp-model-context-protocol/fc-vs-mcp.jpeg)
...
![MCP 生态爆发：5800+ Servers，巨头入场](/images/mcp-model-context-protocol/ecosystem.jpeg)
...
![MCP vs Skills：执行能力 vs 知识经验](/images/mcp-model-context-protocol/mcp-vs-skills.jpeg)
