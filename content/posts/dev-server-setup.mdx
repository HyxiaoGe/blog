...
tags:
  ...
  - CI/CD
categories: DevOps
summary: 从零搭建个人开发服务器，覆盖 Docker 部署、GitHub Actions 持续交付、反向代理与监控体系，让多个前后端项目能够稳定联调和演示。
---
...
![Uptime Kuma 服务状态监控面板](https://hyxiao-blog-images.oss-cn-shenzhen.aliyuncs.com/posts/dev-server-setup/UpTime%20Kuma.png)
