...
![Agent Skills：AI 的入职培训手册](/images/agent-skills-guide/cover.jpeg)
...
![渐进式加载：启动时 ~100 tokens → 匹配时加载 SKILL.md → 执行时按需加载](/images/agent-skills-guide/progressive-loading.jpeg)
...
![blog-write Skill 演进之路：从基础流程到配图检查的 5 个版本迭代](/images/agent-skills-guide/skill-evolution.jpeg)
...
![Prompt vs Skills vs MCP vs RAG：协作关系，不是替代](/images/agent-skills-guide/four-concepts.jpeg)
...
![Skills 的未来：标准化、组合化、市场化、智能化](/images/agent-skills-guide/future.jpeg)
