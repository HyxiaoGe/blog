...
![普通 AI vs AI Agent：只能回答 vs 能思考能行动能规划](https://hyxiao-blog-images.oss-cn-shenzhen.aliyuncs.com/posts/ai-agent-how-it-works/agent-vs-ai.jpeg)
...
![ReAct 循环：思考 → 行动 → 观察](https://hyxiao-blog-images.oss-cn-shenzhen.aliyuncs.com/posts/ai-agent-how-it-works/react-loop.jpeg)
...
![Agent Loop 主循环：发送 → 返回 → 判断 → 执行工具或输出结果](https://hyxiao-blog-images.oss-cn-shenzhen.aliyuncs.com/posts/ai-agent-how-it-works/agent-loop.jpeg)
...
![多 Agent 协作：主 Agent 派出子 Agent 并行处理](https://hyxiao-blog-images.oss-cn-shenzhen.aliyuncs.com/posts/ai-agent-how-it-works/multi-agent.jpeg)
...
![Agent 的局限与挑战：幻觉累积、成本效率、安全边界、创造力上限](https://hyxiao-blog-images.oss-cn-shenzhen.aliyuncs.com/posts/ai-agent-how-it-works/challenges.jpeg)
