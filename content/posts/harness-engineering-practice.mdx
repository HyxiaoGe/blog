...
![Harness Engineering：给 AI 编码代理装上缰绳系统](https://hyxiao-blog-images.oss-cn-shenzhen.aliyuncs.com/posts/harness-engineering-practice/cover.jpeg)
...
![四层 Harness 模型：从上下文到自动清扫](https://hyxiao-blog-images.oss-cn-shenzhen.aliyuncs.com/posts/harness-engineering-practice/harness-layers.jpeg)
...
![CI 门禁：架构检查 + Ruff Lint → 通过才能部署](https://hyxiao-blog-images.oss-cn-shenzhen.aliyuncs.com/posts/harness-engineering-practice/ci-pipeline.jpeg)
...
![Superpowers 工作流：从头脑风暴到验证上线](https://hyxiao-blog-images.oss-cn-shenzhen.aliyuncs.com/posts/harness-engineering-practice/superpowers-workflow.jpeg)
