...
![RAG vs Fine-tuning：开卷考试 vs 闭卷考试](https://hyxiao-blog-images.oss-cn-shenzhen.aliyuncs.com/posts/rag-vs-fine-tuning/cover.jpeg)
...
![RAG 工作流程：提问 → 检索 → 拼接 → 生成](https://hyxiao-blog-images.oss-cn-shenzhen.aliyuncs.com/posts/rag-vs-fine-tuning/rag-workflow.jpeg)
...
![成本对比：RAG 前期低持续中 vs Fine-tuning 前期高持续低](https://hyxiao-blog-images.oss-cn-shenzhen.aliyuncs.com/posts/rag-vs-fine-tuning/cost-compare.jpeg)
...
![混合方案：Prompt Engineering → RAG → Fine-tuning 逐步递进](https://hyxiao-blog-images.oss-cn-shenzhen.aliyuncs.com/posts/rag-vs-fine-tuning/hybrid.jpeg)
...
![怎么选？决策指南流程图](https://hyxiao-blog-images.oss-cn-shenzhen.aliyuncs.com/posts/rag-vs-fine-tuning/decision.jpeg)
