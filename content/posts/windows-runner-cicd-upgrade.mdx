...
![Windows 接管构建，Dev 回归运行](/images/windows-runner-cicd-upgrade/cover.jpeg)
...
![从一台机器扛所有事，到构建与运行分离](/images/windows-runner-cicd-upgrade/old-vs-new-pipeline.jpeg)
...
![监控不按服务硬编码，按标签聚合](/images/windows-runner-cicd-upgrade/generic-cicd-monitoring.jpeg)
...
![一条可复用的部署链路](/images/windows-runner-cicd-upgrade/runner-ghcr-flow.jpeg)
